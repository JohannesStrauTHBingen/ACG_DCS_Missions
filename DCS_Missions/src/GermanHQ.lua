...
local gerRecUnits = SET_GROUP:New():FilterCoalitions("red"):FilterPrefixes("GerReccon"):FilterStart()
...
function mission:OnAfterMissionGoals( From, Event, To )
  ...
  local TargetGroup = GROUP:FindByName( "GroundForcesHostShipTaskGroupOne" )
