...
-- It is meant to make a safe spawn area for each coalition
...
function makeMessage(message)
  MessageToAll(message, 60 ,"The Red Team has managed to free Beslan! Red players can spawn there now")
end
