...
redClientGroupSet = SET_GROUP:FilterPrefixes("Blue_")
  :FilterStart()
  :ForEachGroupCompletelyInZone(ZONE:New("SpawnProtectionZoneRed"),
    function(groupObject)
      groupObject:Destroy()
    end)

blueClientGroupSet = SET_GROUP:FilterPrefixes("Red_")
  :FilterStart()
  :ForEachGroupCompletelyInZone(ZONE:New("SpawnProtectionZoneBlue"),function(groupObject)
    groupObject:Destroy()
  end)
